...
public class StrategicBomber : AircraftBase
{
    [Header("Strategic bomber properties")]
    [SerializeField] private WeaponBombDropper weaponUnguidedBombDropper;
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            if (target)
            {
                ...
                if (target.position.x >= pos2.x && target.position.x <= pos1.x && currentBombs > 0)
                {
                    ...
                    if (weaponUnguidedBombDropper.DropBomb())
                    {
                        currentBombs--;
                    }
    ...
    protected override void OnEnable()
    {
        ...
        bombing = true;
        currentBombs = amountOfBombs;
        weaponUnguidedBombDropper.whatAreOurProjectiles = whatAreOurProjectiles;
        weaponUnguidedBombDropper.ownerRb = thisRb;
    }
